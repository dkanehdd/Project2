      ...
      <li class="nav-item">
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<!-- Breadcrumbs-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="#">상품수정</a>
					</li>
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"></i> 상품수정
					</div>
					<div class="card-body">
						<div class="table-responsive">
							<form enctype="multipart/form-data" onsubmit="return checkValidate(this);" action="../market/edit"
						method="post">
							<table class="table table-bordered" id="dataTable" width="100%"
								cellspacing="0">
							<input type="hidden" name="num" value="<%=dto.getNum()%>"/>
							<input type="hidden" name="originalfile" value="<%=dto.getImage()%>"/>
								<colgroup>
									<col width="20%" />
									<col width="*" />
								</colgroup>
								<tbody>
									<tr>
										...
										<td><input type="text" class="form-control"
											 name="name" value="<%=dto.getGoods_name()%>"/></td>
									</tr>
									<tr>
										<th class="text-center" style="vertical-align: middle;">상품가격</th>
										<td><input type="text" class="form-control"
											name="price" value="<%=dto.getGoods_price()%>"/></td>
									</tr>
									<tr>
										<th class="text-center" style="vertical-align: middle;">마일리지</th>
										<td><input type="text" name="mileage" class="form-control" value="<%=dto.getGoods_mileage()%>"/></td>
									</tr>
									<tr>
										<th class="text-center" style="vertical-align: middle;">상품정보</th>
										<td><textarea rows="10" name="content" class="form-control"><%=dto.getGoods_content()%></textarea>
										</td>
									</tr>
									<tr>
