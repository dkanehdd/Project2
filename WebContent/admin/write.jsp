      ...
      <li class="nav-item">
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<!-- Breadcrumbs-->
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="#"><%=flag%></a>
					</li>
								...
								<input type="hidden" name="flag" value="<%=flag %>" />
									<tr>
										...
										<td><input type="text" class="form-control" name="id"
											style="width: 100px;" value="<%=dto.getId() %>" readonly="readonly"/></td>
									</tr>
									<tr>
									...
									<tr>
										<td>
											...
											<button class="btn btn-info" type='button' value=" 리스트 "
												onClick="javascript:location.href='noticeboard.jsp?flag=<%=flag%>';">리스트보기</button>
