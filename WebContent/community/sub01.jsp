					...
					<div>
											...
											<c:forEach items="${lists }" var="row" varStatus="loop">
												...
												<tr>
													...
													<td class="text-left"><a
														href="../community/view?num=${row.num }&admin=T&nowPage=${map.nowPage}&searchColumn=${param.searchColumn}&searchWord=${param.searchWord}">
															${row.title } </a></td>
						...
						<div class="row text-right" style="">
							...
							<button type="button" class="btn btn-default"
								onclick="location.href='../community/write?flag=admin';">글쓰기</button>
