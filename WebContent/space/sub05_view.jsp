...
<div class="row text-center" style="">
	...
	<button type="button" class="btn btn-danger mr-auto" onclick="location.href='deleteProc.jsp?num=<%=num%>&attachedfile=<%=dto.getAttachedfile()%>&flag=<%=dto.getFlag()%>'">삭제하기</button>	
	<%}%>
